...
// get Posts
function getPosts() {
  _easyhttp.easyHttp.get('' + URLs.base + URLs.getAllPosts).then(function (data) {
...
function submitPost(e) {
  ...
  if (title !== "" && body !== "") {
    ...
    _easyhttp.easyHttp.post('' + URLs.base + URLs.addPost, dataToSend).then(function (data) {
      _ui.ui.showAlert("Post Added!", "alert alert-info");
      _ui.ui.clearFields();
      getPosts();
    }).catch(function (err) {
      console.log(err);
...
var EasyHTTP = function () {
  ...
  _createClass(EasyHTTP, [{
    ...
    key: "post",
    value: function () {
      var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(url, dataToSend) {
        var res, data;
    ...
    key: "put",
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(url, dataToSend) {
        var res, data;
...
var easyHttp = exports.easyHttp = new EasyHTTP();
...
var UI = function () {
  ...
  _createClass(UI, [{
    ...
    value: function clearAlert() {
      var currentAlert = document.querySelector("div.alert");
